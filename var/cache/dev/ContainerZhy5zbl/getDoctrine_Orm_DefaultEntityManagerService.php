...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\StoryRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\StoryRepository']) ? $this->services['App\Repository\StoryRepository'] : $this->load('getStoryRepositoryService.php')) && false ?: '_'};
}))));
