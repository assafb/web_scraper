...
// Returns the private 'App\Repository\StoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StoryRepository.php';

return $this->services['App\Repository\StoryRepository'] = new \App\Repository\StoryRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
